...
TEST_CASE(MetricsLogLine_EncodesUnknownDecodeMode) {
  ...
  EXPECT_EQ(line,
            "1,sess_2,30,30,0,unknown,unknown,0,normal,0,normal,0.000,0,0,0.000,0.000,0,0,0,unknown,0\n");
}
...
TEST_CASE(MetricsLogLine_EncodesCpuNv12FallbackPath) {
  ...
  EXPECT_EQ(line,
            "2,sess_3,30,30,1,mf,cpu_nv12_fallback,0,eco,0,normal,0.000,0,0,0.000,0.000,1,36,256,device_manager_reset_failed,-2005270523\n");
}
